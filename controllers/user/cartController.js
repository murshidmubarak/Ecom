...
const addToCart = async (req, res) => {
    try {
        ...
        console.log("Add to cart - Cookies:", req.cookies);
        const { productId, _csrf } = req.body;
        const userId = req.session.user;

        console.log("Add to cart - Received productId:", productId, "_csrf:", _csrf);
...
const changeQuantity = async (req, res) => {
    try {
        console.log("Change quantity - Request body:", req.body);
        console.log("Change quantity - Cookies:", req.cookies);
        const { productId, count, _csrf } = req.body;
        const userId = req.session.user;

        console.log("Change quantity - ProductId:", productId, "Count:", count, "_csrf:", _csrf);
...
const addTowishlist = async (req, res) => {
    try {
        ...
        console.log("Add to wishlist - Cookies:", req.cookies);
        const { productId, _csrf } = req.body;
        const userId = req.session.user;

        console.log("Add to wishlist - ProductId:", productId, "_csrf:", _csrf);
...
const removeFromWishlist = async (req, res) => {
    try {
        ...
        console.log("Remove from wishlist - Cookies:", req.cookies);
        const { productId, _csrf } = req.body;
        const userId = req.session.user;

        console.log("Remove from wishlist - ProductId:", productId, "_csrf:", _csrf);
